...
public class Recieving_Activity extends AppCompatActivity  implements Sending_Adapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("docs").child(number).child("receive");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putStringArrayListExtra("urls", (ArrayList<String>) names);
                        startActivity(i);
                    }
                });
